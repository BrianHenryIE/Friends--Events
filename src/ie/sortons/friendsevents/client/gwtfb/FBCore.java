package ie.sortons.friendsevents.client.gwtfb;
 ...
 * 
 * Slightly modified version of the gwtfb.com sdk
 * 
...
public class FBCore {
	...
	public native void api (String path, AsyncCallback<JavaScriptObject> callback) /*-{
		...
		$wnd.FB.api (path, function(response){
	        app.@ie.sortons.friendsevents.client.gwtfb.FBCore::callbackSuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/google/gwt/core/client/JavaScriptObject;)(callback,response);
		});
	}-*/;
